...
| [`READINESS_LEDGER.md`](./READINESS_LEDGER.md) | Readiness status (**`READY FOR DOWNSTREAM ADOPTION`** — see [`CLARITY_READINESS_SCORECARD.md`](./CLARITY_READINESS_SCORECARD.md)) |
...
*Introduced: M22 — Operating Manual & Honest Implementation Matrix. Readiness status: **`READY FOR DOWNSTREAM ADOPTION`** (M25 — see [`CLARITY_READINESS_SCORECARD.md`](./CLARITY_READINESS_SCORECARD.md), [`READINESS_LEDGER.md`](./READINESS_LEDGER.md)).*
